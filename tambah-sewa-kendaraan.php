...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $query = "INSERT INTO sewa_kendaraan (no_pelanggan, merek, tgl_sewa, tgl_kembali, harga, lama_sewa, total)
            VALUES ('$no_pelanggan', '$merek', '$tgl_sewa', '$tgl_kembali', '$harga', '$lama_sewa', '$total')";
